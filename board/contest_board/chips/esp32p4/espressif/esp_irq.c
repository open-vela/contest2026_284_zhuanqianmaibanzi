...
/* CPU interrupts can be detached from any interrupt source by routing it to
 * an interrupt line reserved as a disabled sink.
 */
...
#ifdef CONFIG_ARCH_CHIP_ESP32P4
      if (esprv_int_get_type(cpuint) == INTR_TYPE_EDGE)
        {
